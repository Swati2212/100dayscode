...
class InternetSpeedTwitterBot:
    ...
    def get_internet_speed(self):
        ...
        self.down = self.driver.find_element_by_id('speed-value')
        print(f"down:{self.down.text}")


        self.up = self.driver.find_element_by_id('upload-value')
    ...
    def tweet_at_provider(self):
        ...
        tweet_button = self.driver.find_element_by_xpath('//*[@id="react-root"]/div/div/div[2]/main/div/div/div/div[1]/div/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div[3]/div/div/div[2]/div')
        tweet_button.click()
